...
STW-FORM uses CL-COMP, a thin wrapper around [[https://github.com/pcostanza/contextl][CONTEXTL]]. For further information about the protocol STW-FORM uses to define please see the documentation for [[https://github.com/liamhowley/cl-comp][CL-COMP]]. With that said, the section on class definition initialization is repeated here:
